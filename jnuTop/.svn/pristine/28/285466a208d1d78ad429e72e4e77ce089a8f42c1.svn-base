...
public class ExcelReader {
	...
	public static List<Sample> read(File file) throws NonullException, InvalidFormatException, IOException, ParseException, org.apache.poi.openxml4j.exceptions.InvalidFormatException
	{
