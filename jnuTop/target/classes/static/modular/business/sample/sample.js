...
Sample.initColumn = function () {
    return [
        ...
        {title: '是否需要提取', field: 'extracted', visible: true, align: 'center', valign: 'middle'},
        {title: '样本储存位置', field: 'sample_storage', visible: true, align: 'center', valign: 'middle'},
        {title: '报告所需时间', field: 'detection_duration', visible: true, align: 'center', valign: 'middle'},
        {
            title: '修改记录', field: 'opt', visible: true, align: 'center', valign: 'middle',
...
Sample.uploadAttachment = function (id) {
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/sample/sample_uploadAttachment/'+id
    });
